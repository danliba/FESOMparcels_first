...
#SBATCH --output=Pplot_interp_%j.log
#SBATCH --error=Pplot_error_%j.log
...
notebook_path="/gxfs_work/geomar/smomw662/FESOMparcels_first/notebooks/density_plot.ipynb"
output_notebook="/gxfs_work/geomar/smomw662/FESOMparcels_first/notebooks/density_plot_out.ipynb"
